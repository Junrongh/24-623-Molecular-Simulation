...
plt.title(r'Temperature & Time-averaged Temperature vs t, $\nu=5$')
...
plt.figure(figsize=(7, 5))
plt.hist(Momenta[:, 1], 500, label='x')
plt.hist(Momenta[:, 2], 500, label='y')
plt.hist(Momenta[:, 3], 500, label='z')
# plt.xlim([0, 200])
# plt.ylim([-3e-12, 3e-12])
# plt.xlabel('Time')
# plt.ylabel('xyz-Momenta')
plt.title(r'Momenta histogram, $\nu=5$')
plt.legend(loc='upper right')
